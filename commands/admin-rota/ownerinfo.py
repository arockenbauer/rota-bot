...
class AdminOwnerInfoCommand2(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.whitelisted_user_id = 1345092292045836409  # L'ID utilisateur autorisé
...
async def setup(bot):
    await bot.add_cog(AdminOwnerInfoCommand2(bot))
